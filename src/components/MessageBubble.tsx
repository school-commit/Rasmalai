    ...
    <div className={`msg-row ${isUser ? "msg-row-user" : "msg-row-ai"}`}>
      ...
      <div className="msg-col">
        ...
        <div className={`msg-bubble ${isUser ? "msg-bubble-user" : "msg-bubble-ai"}`}>
          ...
          {!isUser && isStreaming && displayedContent.length < message.content.length && (
      ...
      <style>{`
        ...
        .typing-caret { display: inline-block; margin-left: 2px; opacity: .75; animation: caretBlink .7s step-end infinite; }
